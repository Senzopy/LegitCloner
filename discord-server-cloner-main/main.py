...
async def main():
    ...
    # Key validation
    while True:
        key = input(f'{Style.BRIGHT}{Fore.MAGENTA}Insert your key to proceed:{Style.RESET_ALL}{Fore.RESET}\n > ')
        if key in VALID_KEYS:
            print(f'{Style.BRIGHT}{Fore.GREEN}Key is valid!{Style.RESET_ALL}{Fore.RESET}')
            break
        else:
            print(f'{Style.BRIGHT}{Fore.RED}Invalid key. Please try again.{Style.RESET_ALL}{Fore.RESET}')
